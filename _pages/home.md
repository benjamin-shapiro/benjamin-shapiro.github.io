...
<section class="hero">
  ...
  <div class="hero__body">
    ...
    <p>
      ...
      brings together some of the projects that curiosity has led me to build and explore.
    </p>
    <p>
      I hope you enjoy!
    </p>
...
<section class="section" id="selected-work">
  ...
  <div class="project-grid">
    ...
    <article class="project-card">
      <a class="project-card__media" href="/Space#light-sail" aria-label="View LightSail Deployment Sim project">
        <img src="/Images/AlphaAnim3.gif" alt="LightSail deployment simulation" />
      </a>
      <div class="project-card__body">
    ...
    <a class="project-card" href="/Geo#aromap">
      <div class="project-card__media">
        <img src="/Images/Aromap2.png" alt="Aromap smell submission interface" />
      </div>
      <div class="project-card__body">
